class FsQuestion extends HTMLElement {
    constructor() {
        ...
        this.classes = null;
        this.reply = null;
        this.endpoint = 'faceted.ddns.net:5000';
    }
    ...
    get template() {
        ...
        <div class='comp'>
          <p class='question'>
            Onko rakennuksessa <span>${this.question}</span>?
          </p>
    ...
    async connectedCallback() {
        // impl cors on backend before these can be used
...
const testidata = [
    ...
    {
        'class_name': 'Ympärivuotiseen käyttöön soveltuvat vapaa-ajan asuinrakennukset',
        'class_id': '0210',
        'score': 0,
    },
    {
        'class_name': 'Osavuotiseen käyttöön soveltuvat vapaa-ajan asuinrakennukset',
        'class_id': '0211',
        'score': 0,
    },
    {
    ...
    {
        'class_name': 'Järjestöjen, liittojen, työnantajien ja vastaavien opetusrakennukset',
        'class_id': '0891',
        'score': 0,
    },
    {
    ...
    {
        'class_name': 'Jätteenkeruu-, jätteenkäsittely- ja jätteenvarastointirakennukset',
        'class_id': '1120',
        'score': 0,
    },
    {
    ...
    {
        'class_name': 'Logistiikkakeskukset ja muut monikäyttöiset varastorakennukset',
        'class_id': '1214',
        'score': 0,
    },
    {
